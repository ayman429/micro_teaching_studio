...
class GrammarQuizCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: BlocBuilder<GrammarQuizCubit, ClassroomQuizState>(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppStrings.grammarQuizPrompt.tr(),
                      style: getBoldStyle(
                    ...
                    SizedBox(height: AppPadding.p16.h),
                    for (var index = 0;
                        index < GrammarScript.quizItems.length;
                        index++) ...[
                      _QuestionBlock(
                        index: index,
                        ...
                        onSelected: (choice) => context
                            .read<GrammarQuizCubit>()
                            .select(index, choice),
                      ),
                      if (index < GrammarScript.quizItems.length - 1)
                        SizedBox(height: AppPadding.p16.h),
                    ],
                    ...
                    SizedBox(
                      ...
                      child: DefaultButtonWidget(
                        onPressed: state.canSubmit
                            ? () => context.read<GrammarQuizCubit>().submit()
                            : null,
...
class _QuestionBlock extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final item = GrammarScript.quizItems[index];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
...
class _FeedbackBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final key = switch (tone) {
      QuizTone.correct => AppStrings.grammarQuizCorrect,
      QuizTone.review => AppStrings.grammarQuizRetry,
      _ => AppStrings.grammarQuizWrong,
    };
    return Container(
      width: double.infinity,
